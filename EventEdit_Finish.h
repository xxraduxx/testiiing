...
// CEventEdit_Finish form view

class CEventEdit_Finish : public CFormView, public CEventEditWizardCommon
{
	DECLARE_DYNCREATE(CEventEdit_Finish)

protected:
	CEventEdit_Finish();           // protected constructor used by dynamic creation
	virtual ~CEventEdit_Finish();

public:
	enum { IDD = IDD_EVENTEDIT_FINISH };
#ifdef _DEBUG
